...
import {
  ...
  Megaphone, Send, XCircle, CheckCircle, Loader, Calendar
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  // API base URL - Updated to use admin endpoint
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-25">
        ...
        {dataLoading ? (
          ...
          <div className="space-y-8">
            ...
            {/* 1. QUICK ACTIONS BAR - Admin focused */}
            <div className="bg-gradient-to-r from-[#1E2566] to-[#2F87C3] p-5 rounded-xl border-0 shadow-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-white">
              <div className="flex items-center gap-2">
                ...
                <div>
                   ...
                   <p className="text-xs text-white/80">Manage residents and requests</p>
                </div>
              </div>
